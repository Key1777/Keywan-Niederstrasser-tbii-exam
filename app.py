...
def clubs():
    ...
    hsv.pack(side=tk.BOTTOM, pady=1)  # Add padding for spacing
    ...
    stpauli.pack(side=tk.BOTTOM, pady=1)  # Add padding for spacing
...
def game2():
    ...
    while running:
        ...
        pg.draw.circle(screen, BLACK, (player_x, player_y), ball_radius)

        # Draw the enemies
        for enemy_x, enemy_y in enemies:
            pg.draw.rect(screen, RED, (enemy_x, enemy_y, 20, 20))
